...
class QSGDBucketCompressor(Compressor):
    ...
    def compress(self, tensor, name=""):
        ...
        self._compressed_size = self.bucket_size * 32 + tensor.numel() * (1 + np.ceil(np.log2(self.quantum_num)))
    ...
    def calculate_size(self, numel):
        ...
        self._compressed_size  = self.bucket_size * 32 + res_bits # in bits
